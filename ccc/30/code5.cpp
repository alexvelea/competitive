...
int main(int argc, char** argv) {
    ...
    int tower_gold_cost; cin >> tower_gold_cost;
    int num_gold; cin >> num_gold;
...
*/
    ...
    while (1) {
        towers.clear();
        int num_towers = num_gold / tower_gold_cost;
        ...
        while (itr < (int)all_tower_orders.size() and  (int)towers.size() < num_towers) {
